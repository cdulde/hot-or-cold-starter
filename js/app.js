...
// The $(document).ready() function(s) will run once the page loads
$(document).ready(function(){
	...
	function checkTemparature(guessDifference) {
		...
		if (guessDifference == 0) {
			...
			found = true;
			return false;
		} else if (guessCount==1 && userChoice>randomNumber) {
		    setFeedback("Your 1st Guess is too HIGH!");
		    return true;
		}else if (guessCount==1 && userChoice<randomNumber) {
		    setFeedback("Your 1st Guess is too LOW!");
		    return true;
		}else if (guessDifference <= 5) {
			setFeedback("Your Guess is Samsung Note 7 Hot!!");
			return true;
